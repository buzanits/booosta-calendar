...
class Event extends \booosta\Base\base
{
  protected $id, $name, $date, $enddate, $link, $link_target, $description, $settings, $color, $readonly, $background;
  ...
  public function set_eventsettings($val) { $this->settings = $val; }
  public function set_background($val) { $this->background = $val; }

  public function get_eventsetting($key) { return $this->settings[$key]; }
  public function set_eventsetting($key, $val) { $this->settings[$key] = $val; }
